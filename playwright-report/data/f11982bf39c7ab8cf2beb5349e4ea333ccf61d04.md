...
- Name: auth.spec.ts >> OAuth Google (flujo simulado) >> Callback OAuth con token válido guarda el token y redirige al dashboard
- Location: tests/auth.spec.ts:146:7
